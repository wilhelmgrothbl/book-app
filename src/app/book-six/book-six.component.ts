...
@Component({
  selector: 'app-book-six',
  templateUrl: './book-six.component.html',
  styleUrls: ['./book-six.component.sass']
})
export class BookSixComponent {
  book?: Book;
  currentPage = 1;
  bookTitle!: string;
  bookAuthor!: string;
  ...
  ngOnInit() {
    this.http.get<Book>('/assets/bok-6.json').subscribe(book => {
      this.book = book;
